...
// Hapus node setelah elemen tertentu
...
int main() {
    do {
        ...
        if (pilihan == 1) {
            ...
            cout << "Masukkan data yang ingin dihapus setelahnya: ";
            cin >> target;
            deleteAfter(target);
        } else if (pilihan == 7) {
            cout << "Masukkan data yang ingin dihapus sebelumnya: ";
            cin >> target;
            deleteBefore(target);
        } else if (pilihan != 0) {
